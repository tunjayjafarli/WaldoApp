...
import waldo.exceptions.IllegalBusException;
import waldo.exceptions.IllegalBusStopException;
...
public class TranslinkService {
	 ...
	 * Translink service
	 */
	// Complete with your key from developer.translink.ca
	private final static String APIKEY = "pvrfQKSSaaIO6CiYXnVM"; 
